export default {
  ...
  'tool.exitPlanMode.keepContext.description': 'Continue implementation in the current Claude transcript.',
  'tool.exitPlanMode.clearContext.title': 'Clear context',
  'tool.exitPlanMode.clearContext.description': 'Start implementation in a fresh Claude transcript.',
