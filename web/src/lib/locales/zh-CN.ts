export default {
  ...
  'tool.exitPlanMode.selected': '已选选项',
  'tool.exitPlanMode.keepContext.title': '保留上下文',
  'tool.exitPlanMode.keepContext.description': '在当前 Claude transcript 中继续实现。',
  'tool.exitPlanMode.clearContext.title': '清除上下文',
  'tool.exitPlanMode.clearContext.description': '在全新的 Claude transcript 中开始实现。',
